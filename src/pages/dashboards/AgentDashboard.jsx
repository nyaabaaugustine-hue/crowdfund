...
import { TrendingUp, Users, DollarSign, Briefcase, PlusCircle, CheckCircle, Clock, Award } from 'lucide-react'
      ...
      {showCreate && (
        <div className="modal-overlay">
          <div className="modal-box max-w-lg" style={{ borderRadius:'24px', alignSelf:'center' }}>
            <h2 className="font-display font-bold text-2xl text-gray-900 mb-5">Create Campaign for Client</h2>
