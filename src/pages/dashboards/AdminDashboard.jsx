...
import { Shield, CheckCircle, XCircle, Flag, Users, TrendingUp, Eye, DollarSign, AlertTriangle, Search } from 'lucide-react'
  ...
  return (
    <div className="min-h-screen bg-[#F9F6EF]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        {/* Tabs */}
        <div className="flex gap-1 bg-white rounded-2xl p-1 border border-[#F0EDE4] mb-6 shadow-warm flex-wrap sm:flex-nowrap">
