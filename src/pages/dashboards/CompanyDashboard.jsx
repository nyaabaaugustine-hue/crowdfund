...
import { TrendingUp, Users, Target, Award, PlusCircle, Globe, BarChart2, CheckCircle, Menu, X } from 'lucide-react'
...
export default function CompanyDashboard() {
  ...
  const handleCreate = () => {
    ...
    createCampaign({ ...createData, target:Number(createData.target), image:'https://res.cloudinary.com/dwsl2ktt2/image/upload/v1776083653/cvb_touqa8.jpg', creatorId:'company-001', verified:true })
    setShowCreate(false)
    ...
    <div className="min-h-screen bg-[#F9F6EF] flex flex-col">
      ...
      <div className="flex flex-1">
        ...
        <button
          ...
          className="fixed bottom-6 right-6 z-30 lg:hidden w-14 h-14 bg-[#0B4D2B] text-white rounded-full shadow-lg flex items-center justify-center hover:bg-[#065F46] transition-colors"
        >
          <Menu size={24} />
        </button>
      ...
      {showCreate && (
        <div className="modal-overlay">
          <div className="modal-box max-w-lg" style={{ borderRadius:'24px', alignSelf:'center' }}>
            <div className="flex items-center justify-between mb-5">
              <h2 className="font-display font-bold text-2xl text-gray-900">Create Organisation Campaign</h2>
